    ...
    <ProtectedRoute>
      ...
      >
        ...
        <section className="flex-1 p-8">
          ...
          <p style={{ color: "var(--muted)" }} className="mb-8">Welcome to VisualAI</p>
          <div className="grid grid-cols-3 gap-5">
            <div className="card p-6">
              <p style={{ color: "var(--muted)" }}>Processed</p>
              <h2 className="text-3xl mt-2">{stats.processed}</h2>
            </div>
            <div className="card p-6">
              <p style={{ color: "var(--muted)" }}>Speed</p>
              <h2 className="text-3xl mt-2">{stats.avg_time.toFixed(3)}s</h2>
            </div>
            <div className="card p-6">
              <p style={{ color: "var(--muted)" }}>Accuracy</p>
